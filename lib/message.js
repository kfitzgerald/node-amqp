...
// Negative acknowledge receipt of message.
// Set first arg to 'true' to negative-acknowledge this and all previous messages
// received on this queue.
// Set second arg to 'true' to requeue the affected messages
Message.prototype.nAcknowledge = function (all, requeue) {
    this.queue.connection._sendMethod(this.queue.channel, definitions.methods.basicNack,
        {
            reserved1: 0,
            deliveryTag: this.deliveryTag,
            multiple: !!all,
